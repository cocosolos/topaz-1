 ...
 *  Notes   : setMissionStatus(log id, [index], value)
 ************************************************************************/
 ...
 *  Notes   : getMissionStatus(log id, [index])
 ************************************************************************/
