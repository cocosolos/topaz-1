...
entity.onTrigger = function(player, npc)
    ...
    elseif (player:hasKeyItem(tpz.ki.ARCHDUCAL_AUDIENCE_PERMIT) and CurrentMission == tpz.mission.id.nation.NONE and player:getMissionStatus(player:getNation()) == 1) then
