...
def migrate(cur, db):
    ...
    cur.execute("DELETE char_vars FROM char_vars INNER JOIN chars ON char_vars.varname = 'MissionStatus' AND char_vars.charid = chars.charid AND chars.missions IS NOT NULL;")
